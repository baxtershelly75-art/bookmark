// Recovery checkpoint: Genesis 46–50.
// Completes the Genesis recovery set on the safe branch.
...
'Genesis 46':{
 ...
 reflections:['What does Jacob do before making a move he has reason to fear?','How does God’s promise of presence differ from a promise that the road ahead will contain no hardship?'],
 commentary:{voice:'Matthew Henry',identity:'English Nonconformist commentator, 1662–1714',quote:'Those that go whither God sends them shall certainly have God with them.',plain:'Henry centers the comfort exactly where Genesis does: Jacob can enter an uncertain place because God promises to be with him there.',source:'Commentary on the Whole Bible — Genesis 46:1–4',url:'https://biblehub.com/commentaries/mhcw/genesis/46.htm'},
 question:{q:'Did God fail to “bring Jacob up again” since Jacob died in Egypt?',short:'No. Jacob’s body is carried back to Canaan for burial, and the larger family promise is fulfilled when Israel is later brought out of Egypt.',more:'Genesis itself prepares both senses. Jacob is deeply concerned that he not be buried in Egypt, and Genesis 50 records his burial in Canaan. The promise also belongs to the covenant family, whose exodus from Egypt has already been anticipated in Genesis 15.'}
},
'Genesis 47':{
 ...
 reflections:['What does Jacob’s blessing of Pharaoh show about the relationship between social rank and spiritual calling?','Where do I see both real provision in Egypt and a refusal to treat Egypt as the family’s final home?'],
 commentary:{voice:'John Gill',identity:'English Baptist pastor and commentator, 1697–1771',quote:'wished him health and happiness, prayed for his welfare',plain:'Gill reads Jacob’s blessing as more than a polite greeting: the patriarch genuinely prays for the ruler who has received his family.',source:'Exposition of the Entire Bible — Genesis 47:7',url:'https://biblehub.com/commentaries/gill/genesis/47.htm'},
 question:{q:'Does Genesis 47 endorse Joseph’s famine policy as the ideal way governments should operate?',short:'The chapter records what Joseph did and how Egypt changed under the famine; it does not give a command that later governments must copy the policy.',more:'The narrative emphasizes survival during an extreme famine, Pharaoh’s growing ownership, the people’s response, and the continuing fifth. We can study the arrangement carefully without turning a descriptive episode in ancient Egypt into a universal economic rule.'}
},
'Genesis 48':{
 ...
 reflections:['What parts of Jacob’s life make his description of God as Shepherd especially meaningful?','Where has God’s kindness exceeded what Jacob once expected to live long enough to see?'],
 commentary:{voice:'C. H. Spurgeon',identity:'Baptist preacher, 1834–1892',quote:'God has shepherded me all my life long.',plain:'Spurgeon lingers over Jacob’s old-age testimony: through wandering, mistakes, danger, provision, and change, Jacob can look back and recognize God’s shepherding care.',source:'A Bit of History for Old and Young — Genesis 48:15–16, preached 10 July 1887',url:'https://www.spurgeon.org/sermons/a-bit-of-history-for-old-and-young'},
 question:{q:'Did Jacob accidentally bless Ephraim with his right hand because he was old and nearly blind?',short:'No. Verse 14 says he guided his hands “wittingly,” and when Joseph tries to correct him, Jacob explicitly refuses.',more:'The reversal is deliberate. Genesis has repeatedly shown God’s purpose crossing ordinary birth-order expectations—Isaac over Ishmael and Jacob over Esau—and the pattern appears again with Ephraim and Manasseh.'}
},
'Genesis 49':{
 ...
 reflections:['Which son receives words that connect most clearly to something he has already done in Genesis?','Why might Jacob’s many names for God in Joseph’s blessing matter after such a long and difficult family history?'],
 commentary:{voice:'Alexander Maclaren',identity:'Scottish Baptist preacher and expositor, 1826–1910',quote:'This exuberant heaping together of names of God is the mark of the flash of rapturous confidence.',plain:'Maclaren notices how Jacob’s language expands when he reaches the God who sustained Joseph: one title is not enough for the dying patriarch’s confidence.',source:'Expositions of Holy Scripture — Genesis 49:24',url:'https://biblehub.com/commentaries/maclaren/genesis/49.htm'},
 question:{q:'Who or what is “Shiloh” in Genesis 49:10?',short:'The Hebrew phrase is difficult, and translations have rendered it in more than one way. Christians have long read the verse within the messianic hope attached to Judah.',more:'Bookmark should not pretend the word itself is easy. What is clear in the chapter is the scepter and ruler imagery given to Judah. Later Scripture identifies Israel’s Messiah with Judah’s line—Jesus is from Judah, and Revelation calls Him the Lion of the tribe of Judah.'}
},
'Genesis 50':{
 ...
 reflections:['How does Joseph keep truth, forgiveness, and God’s providence together without denying any of them?','Why is Joseph’s request about his bones an act of faith rather than merely sentiment about burial?'],
 commentary:{voice:'Matthew Henry',identity:'English Nonconformist commentator, 1662–1714',quote:'Those we love and forgive we must not only do well for but speak kindly to.',plain:'Henry notices that Joseph’s forgiveness becomes concrete: he reassures frightened people, promises provision, and speaks to their hearts rather than keeping them afraid.',source:'Commentary on Genesis 50:15–21',url:'https://www.biblegateway.com/resources/matthew-henry/Gen.50.15-Gen.50.21'},
 question:{q:'Does forgiving his brothers mean Joseph says the past no longer matters?',short:'No. Joseph names what they intended as evil. His forgiveness tells the truth about the wrong while refusing revenge and choosing continued care.',more:'Genesis 50 is especially helpful because it does not confuse forgiveness with moral amnesia. Joseph can say “ye thought evil against me,” recognize God’s different good purpose, weep at his brothers’ fear, and then feed and comfort the people who once harmed him.'}
}
});
