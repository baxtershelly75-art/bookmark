// Recovery checkpoint: Genesis 36–45.
// Joseph narrative cards keep human guilt and divine providence distinct.
...
'Genesis 36':{
 ...
 reflections:['How does knowing that Edom is Esau’s family change the way later conflicts with Edom will read?','What does this chapter show about God’s providence extending beyond the one covenant line Genesis is following most closely?'],
 commentary:{voice:'Matthew Henry',identity:'English Nonconformist commentator, 1662–1714',quote:'It is to show the performance of the promise to Abraham.',plain:'Henry notices that Esau’s expanding family is part of the larger promise that Abraham would become father of many nations, even though Genesis now follows Jacob’s line.',source:'Commentary on Genesis 36',url:'https://search.biblegateway.com/resources/matthew-henry/Gen.36.1-Gen.36.43'},
 question:{q:'Why devote a whole chapter to Esau’s descendants if Jacob carries the covenant line?',short:'Because Esau’s family becomes Edom, an important neighboring nation in the rest of the Bible, and because his growth also fulfills promises already made.',more:'Genealogies often feel slow when read alone but become useful later. Genesis 36 gives Israel’s readers the family relationship behind Edom and locates several peoples and rulers who will appear again.'}
},
'Genesis 37':{
 ...
 reflections:['Where do favoritism, envy, and group cruelty build on one another in this chapter?','How can I distinguish God’s later use of this evil from any idea that the brothers’ evil itself was good?'],
 commentary:{voice:'Alexander Maclaren',identity:'Scottish Baptist preacher and expositor, 1826–1910',quote:'God works out His great purposes through even the crimes of unconscious men.',plain:'Maclaren does not call the brothers’ cruelty good. He is pointing to the larger Joseph story, where human evil becomes something God overrules for preservation.',source:'The Trials and Visions of Devout Youth — Genesis 37',url:'https://biblehub.com/commentaries/maclaren/genesis/37.htm'},
 question:{q:'Did God make Joseph’s brothers sell him?',short:'Genesis holds the brothers responsible for real evil while later showing that God sovereignly used what they did for a saving purpose.',more:'Joseph’s clearest summary comes in Genesis 50:20: “ye thought evil against me; but God meant it unto good.” The same event can contain guilty human intention and a good divine purpose without making those intentions identical.'}
},
'Genesis 38':{
 ...
 reflections:['Where does Judah finally stop judging someone else long enough to recognize his own wrongdoing?','How does this chapter prepare me to notice change in Judah later in the Joseph story?'],
 commentary:{voice:'John Calvin',identity:'Reformation pastor and commentator, 1509–1564',quote:'Judah acted very unjustly in keeping one bound, whom he intended to defraud.',plain:'Calvin squarely identifies Judah’s wrongdoing toward Tamar before discussing her later deceptive response.',source:'Commentary on Genesis 38:11',url:'https://biblehub.com/commentaries/calvin/genesis/38.htm'},
 question:{q:'Does “more righteous than I” mean Tamar did nothing wrong?',short:'Not necessarily. Judah’s statement is a comparison and a confession that his failure toward her was the deeper wrong driving the situation.',more:'Genesis does not turn the story into a simple hero-villain tale. Judah withheld what he owed Tamar, then judged her harshly while hiding his own conduct. His confession matters because he finally recognizes his responsibility.'}
},
'Genesis 39':{
 ...
 reflections:['What reasons does Joseph give himself for saying no?','How does the repeated phrase “the LORD was with Joseph” change what I think God’s presence must look like?'],
 commentary:{voice:'C. H. Spurgeon',identity:'Baptist preacher, 1834–1892',quote:'The Lord was with Joseph, but it did not screen him from temptation of the worst kind.',plain:'Spurgeon notices the chapter’s tension: God’s presence is real, but it does not remove temptation, slander, or suffering.',source:'A Miniature Portrait of Joseph — Genesis 39:2',url:'https://www.spurgeon.org/resource-library/sermons/a-miniature-portrait-of-joseph/'},
 question:{q:'Why was Joseph punished if he did the right thing?',short:'Because people can lie and misuse power. Genesis does not promise that integrity always receives immediate justice from other people.',more:'Joseph’s innocence and imprisonment sit side by side. The chapter’s answer is not that prison is good, but that God remains with Joseph inside an unjust outcome and continues working through circumstances Joseph cannot control.'}
},
'Genesis 40':{
 ...
 reflections:['What does Joseph’s attention to the two men teach me about serving while carrying my own pain?','Where am I tempted to treat a delayed human response as proof God has forgotten me?'],
 commentary:{voice:'Matthew Henry',identity:'English Nonconformist commentator, 1662–1714',quote:'We cannot expect too little from man nor too much from God.',plain:'Henry draws the contrast at the chapter’s ending: the cupbearer can forget, but Joseph’s story is not ultimately held in the cupbearer’s memory.',source:'Commentary on Genesis 40:20–23',url:'https://www.biblestudytools.com/commentaries/matthew-henry-complete/genesis/40.html'},
 question:{q:'Was Joseph wrong to ask the cupbearer to remember him?',short:'Genesis does not condemn the request. Joseph truthfully explains his injustice and uses a reasonable human opportunity for help.',more:'Trusting God does not forbid asking another person to act justly or to help. The spiritual lesson lies in what happens next: the cupbearer forgets, while God’s providential timing continues beyond Joseph’s preferred route.'}
},
'Genesis 41':{
 ...
 reflections:['What does Joseph do with the gift he has when powerful people finally notice it?','Where does this chapter join spiritual dependence with very ordinary planning, storage, and administration?'],
 commentary:{voice:'Matthew Henry',identity:'English Nonconformist commentator, 1662–1714',quote:'It is the wisdom of princes to prefer those… in whom the Spirit of God is.',plain:'Henry highlights Pharaoh’s recognition that Joseph’s competence is joined to the divine source Joseph himself has already named.',source:'Commentary on Genesis 41:33–45',url:'https://www.biblegateway.com/resources/matthew-henry/Gen.41.33-Gen.41.45'},
 question:{q:'Did Joseph’s success mean the years in prison were unnecessary?',short:'Genesis never calls the injustice necessary or good, but the story shows God bringing Joseph from those years into a role he could not have arranged for himself.',more:'The cupbearer’s imprisonment connected him to Joseph; the cupbearer’s later memory connected Joseph to Pharaoh. Providence can use unjust and painful circumstances without requiring us to rename injustice as goodness.'}
},
'Genesis 42':{
 ...
 reflections:['What detail of their old sin finally troubles the brothers most?','How does Joseph’s private weeping complicate the idea that his rough speech is simple revenge?'],
 commentary:{voice:'Matthew Henry',identity:'English Nonconformist commentator, 1662–1714',quote:'The office of conscience; it is a remembrancer.',plain:'Henry notices that time has not erased what the brothers did. Their present fear awakens memory of Joseph’s anguish and their refusal to hear him.',source:'Commentary on Genesis 42:21–28',url:'https://search.biblegateway.com/resources/matthew-henry/Gen.42.21-Gen.42.28'},
 question:{q:'Was Joseph taking revenge by testing his brothers?',short:'The story points more toward testing repentance and concern for Benjamin than toward simple revenge, though Joseph’s method is severe.',more:'He could have used Egyptian power to destroy them immediately, but he does not. He listens, weeps privately, returns their money, feeds their households, and later reconciles. Genesis 44 will especially show what Joseph is looking for: will they abandon Rachel’s other son to protect themselves, or have they changed?'}
},
'Genesis 43':{
 ...
 reflections:['What evidence is beginning to show that Judah is not the same man he was in Genesis 37?','How do the brothers respond when Benjamin is openly favored in front of them?'],
 commentary:{voice:'Matthew Henry',identity:'English Nonconformist commentator, 1662–1714',quote:'He will not only not wrong him, but will do all he can to protect him.',plain:'Henry sees Judah’s pledge for Benjamin as practical evidence of change: he now commits himself to protect the favored younger brother.',source:'Commentary on Genesis 43:1–10',url:'https://www.biblegateway.com/resources/matthew-henry/Gen.43.1-Gen.43.10'},
 question:{q:'Why does Joseph give Benjamin five times as much food?',short:'Genesis does not directly tell us, but inside this story it creates a revealing situation: another favored son is placed before brothers once consumed by favoritism and envy.',more:'We should label that as a narrative inference rather than certainty. What becomes clear in the next chapter is that the brothers do not sacrifice Benjamin to save themselves; Judah instead offers himself.'}
},
'Genesis 44':{
 ...
 reflections:['What has changed in Judah since Genesis 37?','What does genuine repentance look like when a person faces a situation resembling the one in which they sinned before?'],
 commentary:{voice:'Matthew Henry',identity:'English Nonconformist commentator, 1662–1714',quote:'he was himself willing to be a bondman',plain:'Henry points to the reversal that makes Judah’s plea so powerful: instead of sacrificing the favored brother, Judah offers his own freedom.',source:'Commentary on Genesis 44:18–34',url:'https://www.biblegateway.com/resources/matthew-henry/Gen.44.18-Gen.44.34'},
 question:{q:'Why does Joseph put the cup in Benjamin’s sack?',short:'The test creates a situation where the brothers can again save themselves by abandoning Rachel’s favored son—or show that they have changed.',more:'Genesis does not give Joseph an inner monologue explaining every tactic, so this should remain a careful inference. The outcome is unmistakable: the brothers return together, and Judah offers himself instead of Benjamin. That is the opposite of what happened to Joseph in Genesis 37.'}
},
'Genesis 45':{
 ...
 reflections:['How does Joseph tell the truth about the past without using the truth as a weapon to destroy his brothers?','What is the difference between saying God overruled evil and saying evil was therefore good?'],
 commentary:{voice:'C. H. Spurgeon',identity:'Baptist preacher, 1834–1892',quote:'Man hath the crime, but God hath the triumphing; man rules, but God overrules.',plain:'Spurgeon uses Joseph’s story as a pattern for providence: human agents remain guilty for evil intentions while God can sovereignly bring a saving purpose through what they meant for harm.',source:'Joseph and His Brethren — Genesis 45:3–5, preached 11 May 1862',url:'https://www.spurgeon.org/sermons/joseph-and-his-brethren'},
 question:{q:'Does “God sent me” mean the brothers were not guilty?',short:'No. Joseph explicitly says, “whom ye sold into Egypt,” and later says they meant evil against him.',more:'Genesis 45 emphasizes God’s preserving purpose; Genesis 50:20 makes the distinction especially clear. The brothers’ intention was evil. God’s intention was good. Providence is not moral confusion—it is God’s ability to overrule human evil without becoming its author or excusing its agents.'}
}
});
