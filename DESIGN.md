...
Current published study collection: Genesis 1–50; Psalms 1–150; **Obadiah, Haggai, Joel, Amos, Nahum, Habakkuk, Zephaniah, Jonah, Micah, and Malachi**; and **all New Testament letters Romans–Jude** — **360 carefully developed chapter cards**. This remains a quality responsibility, not a speed target. The interface supports queueing any Bible chapter.

**Genesis 1–50, Psalms 1–150, Obadiah, Haggai, Joel, Amos, Nahum, Habakkuk, Zephaniah, Jonah, Micah, Malachi, and all New Testament letters Romans–Jude are published on `main`.** The final letters wave, James through Jude, merged through PR #17 at commit `d5fd4a97db9e904a42f77566fd571c07f0ce0c1a`; GitHub Pages run `35741806121` completed successfully on that exact commit.
...
**Minor Prophets — first short-book wave:** Obadiah (1 chapter), Haggai (2), Joel (3), Nahum (3), Habakkuk (3), and Zephaniah (3) were built at the Galatians depth standard as the first shortest-to-longest Minor Prophets wave. Difficult or commonly misused passages receive explicit context guardrails, including Obadiah’s date uncertainty, Haggai 2:7, Joel 2:25 and 3:14, Nahum’s judgment imagery, Habakkuk 2:2–4, and Zephaniah 3:17. The 4-chapter wave adds Jonah 1–4 and Malachi 1–4 at the same Galatians depth standard. Micah 1–7 is the next completed wave, preserving its judgment/restoration structure, Bethlehem prophecy, justice themes, and common-context guardrails. Amos 1–9 is the next completed wave, preserving the book’s covenant accountability, justice-and-worship argument, prophetic visions, and Acts 15 reuse. The next planned Minor Prophets step is Hosea 1–14 after Amos is audited and publication is verified.
