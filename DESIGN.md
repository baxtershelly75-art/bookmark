...
Current published study collection: Genesis 1–50; Psalms 1–150; **Matthew 1–28; Mark 1–16; Luke 1–24; John 1–21**; **all Minor Prophets Hosea–Malachi**; and **all New Testament letters Romans–Jude** — **477 carefully developed chapter cards**. This remains a quality responsibility, not a speed target. The interface supports queueing any Bible chapter.

**Genesis 1–50, Psalms 1–150, Matthew 1–28, Mark 1–16, Luke 1–24, John 1–21, all Minor Prophets Hosea–Malachi, and all New Testament letters Romans–Jude are published on `main`.** The final letters wave, James through Jude, merged through PR #17 at commit `d5fd4a97db9e904a42f77566fd571c07f0ce0c1a`; GitHub Pages run `35741806121` completed successfully on that exact commit.
...
**Mark — complete Gospel wave:** Mark 1–16 is built at the Galatians depth standard as the second Gospel collection. The cards preserve Mark’s fast narrative pace while opening deeper layers around authority, discipleship, purity, suffering Messiah themes, service, temple judgment, eschatological watchfulness, the Passion, resurrection witness, and the manuscript history of Mark 16:9–20. Difficult or easily misused passages receive explicit context guardrails.

**Luke — complete Gospel wave:** Luke 1–24 is built in eight three-chapter waves at the Galatians depth standard. The cards preserve Luke’s historical prologue, birth songs, women and outsiders, poor/rich reversals, prayer and the Holy Spirit, Samaritans, table fellowship, Luke-only parables, the travel narrative toward Jerusalem, difficult chronology and manuscript questions, the Passion, Emmaus, bodily resurrection, and the bridge toward Acts. Luke 21 preserves both the clear Jerusalem/AD 70 horizon and the wider Son-of-man horizon without forcing one end-times chart. Sensitive passages include explicit guardrails against victim-blaming, anti-Jewish collective blame, coercive giving, abuse of forgiveness teaching, and careless handling of textual variants.

**John — complete Gospel wave:** John 1–21 is built at the Galatians depth standard as the fourth and final Gospel collection. The cards preserve John’s distinctive signs and “I am” structure, Father/Son/Spirit teaching, festival and Old Testament backgrounds, incarnation and divine-identity claims, new-birth and living-water themes, Good Shepherd and True Vine imagery, the Upper Room discourse and prayer, Passion and resurrection eyewitness detail, and Peter’s restoration. Difficult material receives explicit guardrails, including John 5:3–4 and John 7:53–8:11 textual history, disability/sin misuse, anti-Jewish misuse of intra-Jewish controversy and Passion language, Psalm 82, sacramental disagreements in John 6 and John 20, “My Father is greater than I,” “My kingdom is not of this world,” Greek love-word overreading in John 21, and the 153-fish numerology question. Whole-book publication requires a 21/21 assembly audit, loader verification, merge, and exact-commit Pages verification.
