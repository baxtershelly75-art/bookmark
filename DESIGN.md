...
**Genesis 1–50 and Psalms 1–150 are published on `main`.** Psalms 121–150 were approved with 🐿️ and merged through PR #7 at commit `b04a9a3e9f1efcb849480ad19ec64cc76bcf9371`; the matching GitHub Pages deployment completed successfully.
...
**Galatians checkpoint:** protected branch `galatians-1-6` contains all six Galatians cards. Shelly specifically requested slightly deeper **Notice this** notes and commentary while preserving short physical-Bible margin notes. The six-card audit passes JavaScript syntax/runtime, required-field, clickable verse-reference, source-link, short-quotation, and voice/jargon checks. Galatians remains off live `main` pending Shelly’s review.
