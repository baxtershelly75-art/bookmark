...
Current published study collection: Genesis 1–50; Psalms 1–150; and **all New Testament letters Romans–Jude** — **321 carefully developed chapter cards**. This remains a quality responsibility, not a speed target. The interface supports queueing any Bible chapter.

**Genesis 1–50, Psalms 1–150, and all New Testament letters Romans–Jude are published on `main`.** The final letters wave, James through Jude, merged through PR #17 at commit `d5fd4a97db9e904a42f77566fd571c07f0ce0c1a`; GitHub Pages run `35741806121` completed successfully on that exact commit.
